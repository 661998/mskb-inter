...
namespace Drupal\registration_customization\Controller;
 ...
 */
class RegistrationPdf extends ControllerBase {
  ...
  public function content($nid) {
    ...
    $clc_10 = $migration_10 = $caste_certificate_url = $registration = $ofss = '';
    ...
    $religion = '';
    if (!empty($node->get('field_religion')->target_id)) {
        $religion = current($node->get('field_religion')->referencedEntities())->getName();
    }
    ...
    <style>
     body, p, td, div { font-family: freesans; }
       ...
       <p>नोट: पंजीकरण प्रपत्र भरकर सभी कागजातों सहित हार्ड कॉपी महाविद्यालय कार्यालय में जमा करें अन्यथा पंजीकरण मान्य नहीं समझा जायेगा</p>
            ...
            <tr>
                <td style="width: 70%">
                    ...
                    <table style="width: 100%">
                        ...
                        $data .= '<tr>
                            <th style="width: 50%; text-align: left">Identification Mark</th>
                            <td style="width: 50%">'.$node->get('field_identification_mark')->value.'</td>
                        </tr>
                        <tr>
    ...
    $stylesheet = file_get_contents('modules/custom/registration_customization/css/pdf.css');
